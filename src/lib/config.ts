...
export const APP_CONFIG = {
  appName: "Jewel Club",                     // Display name (sidebar header, page title)
  projectName: "Jewel Club Headless",        // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,         // Client first name, or null — never render "null"
  domain: "luxury-jewelry",                 // Domain classification
